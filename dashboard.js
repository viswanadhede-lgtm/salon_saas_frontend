    ...
    async function fetchAndRenderTopServicesToday(currentBranchId) {
        ...
        try {
            ...
            if (!bookings || bookings.length === 0) {
                listContainer.innerHTML = '<li class="centered-placeholder">No services today.</li>';
                return;
            }
            ...
            const colors = ['#a78bfa', '#34d399', '#60a5fa', '#fb923c', '#f472b6', '#818cf8', '#facc15'];
                    ...
                    <li class="services-today-item">
                        ...
                        <div class="sti-right">
                            <div class="sti-bar-track">
                                <div class="sti-bar" style="width:${pct}%; background:${color}"></div>
                            </div>
