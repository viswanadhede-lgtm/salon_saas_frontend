...
function renderTable() {
    ...
    DOM.tableBody.innerHTML = viewData.map(s => {
        ...
        <tr class="tb-row" style="border-bottom:1px solid #e2e8f0; transition:background 0.2s;">
            ...
            <td style="padding:14px 16px;">
                <button class="icon-btn" style="color:#6366f1; background:#e0e7ff; margin-right:8px;"
                        title="Edit" onclick="alert('Edit schedule')">
                    <i data-feather="edit-2" style="width:14px; height:14px;"></i>
                </button>
                <button class="icon-btn" style="color:#ef4444; background:#fee2e2;"
                        title="Delete" onclick="alert('Delete schedule')">
